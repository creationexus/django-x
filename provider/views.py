...
class AccessToken(OAuthView, Mixin):
    ...
    * :attr:`invalidate_refresh_token`
    ...
    def access_token_response(self, access_token):
        ...
        """
        try:
            u=Users.objects.get(users_id=access_token.user_id)
            response_data={
                ...
                'users_name_id':u.users_name_id,
                'users_email':u.users_email,
                'users_path_web_avatar':u.users_path_web_avatar,
                'users_is_location_enable':u.users_is_location_enable
            }
