...
def HomeHandler(request):
    if request.method == 'GET':
        template_values = {'title':'Register User _ oClock','current_user':''}
        return render_to_response('oclock/facebook-oauth.html', template_values)
...
def LoginHandler(request):
    if request.method == 'GET':
        ...
        if request.REQUEST.get("code"):
            ...
            args["code"] = request.REQUEST.get("code","")
